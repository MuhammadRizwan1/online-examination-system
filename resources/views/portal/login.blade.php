...
<div class="login-form">
    <form action="{{ url('portal/login_sub') }}" class="database_operation" method="post">
        @csrf
    ...
    <p class="text-center text-muted small">Don't have an account? <a href="{{ url("portal/signup") }}">Sign up here!</a></p>
</div>
